...
def get_all_dates(spacenet7_path: str, aoi_id: str, sort_by_date: bool = True) -> list:
    images = "images"
    folder = Path(spacenet7_path) / get_dataset(spacenet7_path, aoi_id) / aoi_id /images
   
    #Folder debugged : works properly
    dates=[]
    
    for f in folder.glob('*'):    
    	dates.append(file2date(f))
...
if __name__ == '__main__':
    print_training_validation_split('C:/Users/shafner/datasets/spacenet7AWS')
    print_test_aoi_ids('C:/Users/shafner/datasets/spacenet7AWS')
